...
$bilo=[];
function nestoit($queryaboba1, $dep, $name){
    ...
    foreach($bdsm as $value){
        ...
        if($value['الإدمان'] == $dep){
            if($value['النوع'] == 1){
                nestoit($queryaboba1, $value['المعرف'], $value['الاسم']);
            }else{
                echo "<br>";
                ?><tr><td></td><td><button><?echo $value['الاسم']." ".$value['التاريخ'];?></td></button><?
            }
        }
    }
}
    ...
    if($fetish_abcoc1['الإدمان'] == 0){
            ...
            ?><a href="kek.html"><?= $fetish_abcoc1['الاسم'] . " " . $fetish_abcoc1['التاريخ'] ?></a><br><? //исправить
                ...
                if ($fetish_abcoc1['النوع'] == 0){
                    ...
                    nestoit($queryaboba1, $fetish_abcoc1['المعرف'], $fetish_abcoc1['الاسم']);
                }
        }
    }
}
